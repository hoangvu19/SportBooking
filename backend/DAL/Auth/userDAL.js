        ...
        try {
            ...
            const result = await pool.request()
                ...
                .query(`
                    SELECT TOP (@limit)
                        AccountID, Username, FullName, Email,
                         Bio, Address, AvatarUrl, Gender, Status, CreatedAt
                    FROM Account
                    WHERE Status = 'Active'
                        AND (
            ...
            throw error;
                ...
                /**
                 * Lấy users theo role name (ví dụ: 'admin')
                 * @param {string} roleName
                 * @returns {Promise<Array>} danh sách accounts cơ bản
                 */
                static async getUsersByRole(roleName) {
                    try {
                        ...
                        const result = await pool.request()
                            ...
                            .query(`
                                SELECT a.AccountID, a.Username, a.FullName, a.Email, a.AvatarUrl, a.Status
                                FROM Account a
                        ...
                        // Return plain objects (controllers expect AccountID/Username/FullName/Email/Avatar)
                        ...
                        console.error('❌ UserDAL.getUsersByRole Error:', error);
                        throw error;
                    }
                }
