import { getVnIsoDate } from './vnTime';
...
const generateNextDays = (days = 7) => {
  ...
  for (let i = 0; i < days; i++) {
    ...
    const iso = getVnIsoDate(date);
    const display = new Intl.DateTimeFormat('vi-VN', { timeZone: 'Asia/Ho_Chi_Minh', weekday: 'short', day: '2-digit', month: '2-digit' }).format(date);
